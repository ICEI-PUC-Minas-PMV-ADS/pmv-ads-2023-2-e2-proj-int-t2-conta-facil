...
A equipe consolidou a definição precisa do problema e identificou os pontos mais relevantes a serem abordados neste projeto através de um processo de imersão, que envolveu a participação dos usuários.
...
|RF-05|O sistema  deverá ter um alerta para não exceder o limite do orçamento.|Baixa|
